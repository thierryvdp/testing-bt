...
public class EmailHome {
	...
	public Email merge(Email detachedInstance) {
		...
		try {
			Email result = (Email) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Email findById(java.lang.Long id) {
		...
		try {
			Email instance = (Email) sessionFactory.getCurrentSession().get(
					"irl.server.data.Email", id);
			if (instance == null) {
	...
	public List findByExample(Email instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"irl.server.data.Email").add(Example.create(instance))
					.list();
