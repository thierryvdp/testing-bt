package chapitre2;
/* Chapitre 2: Section 1, crÈation de geometries elementaires
 * Auteur    : daboul 
 * Date      : 03/00
 */
...
class MonTutoPyramide extends Frame implements WindowListener
{
	...
	MonTutoPyramide()
	{
		super("- Chapitre 2 : geometries Èlementaires -");
...
//		Alpha cadenceAlpha=new Alpha(-1,speedMilli);               // le mouvement est infini et se répète toutes les 4 secondes
//		Point3f[] chemin=new Point3f[3];        // itinéraire
//		chemin[0]=new Point3f(0.8f,0.0f,0.0f);  // itinéraire point 1
//		chemin[1]=new Point3f(-0.8f,0.0f,0.0f); // itinéraire point 2
//		chemin[2]=new Point3f(0.8f,0.0f,0.0f);  // itinéraire point 3 on revient au depart ...
//		float[] timePosition={0.0f,0.50f,1.0f}; // timing pour atteindre chaque point de l'itinéraire
//
//		Transform3D trans=new Transform3D(); // necessaire à l'interpolateur
...
//		interpol.setSchedulingBounds(effectAre); // set l'aire d'effet à l'interpolateur de rotation
...
//		Alpha cadenceAlpha=new Alpha(-1,speedMilli);               // le mouvement est infini et se répète toutes les 4 secondes
//		RotationInterpolator interpol=new RotationInterpolator(cadenceAlpha,spinTransformGroup); // mouvement de rotation à la cadenceAlpha sur le TG
//		BoundingSphere effectAre=new BoundingSphere(); // creation de l'aire d'effet
//		interpol.setSchedulingBounds(effectAre); // set l'aire d'effet à l'interpolateur de rotation
...
//	}
	...
	public Appearance mkFillApp() {
		...
		//material -> uniquement si il y a des lumiËres
