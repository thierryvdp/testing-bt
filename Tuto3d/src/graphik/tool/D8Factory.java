...
public class D8Factory {
	...
	public Geometry getNewD8(float size) {
		int tab[] = new int[1];
		tab[0] = 12;
		TriangleStripArray d8 = new TriangleStripArray(12, TriangleStripArray.COORDINATES | TriangleStripArray.COLOR_3 | TriangleStripArray.NORMALS, tab);
		...
		for (int i = 0; i < 12; i++)
			d8.setColor(i, new Color3f(1f, 0f, 1f));
		return d8;
	}
